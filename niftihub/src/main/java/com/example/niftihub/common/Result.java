package com.example.niftihub.common;
...
public class Result {
    ...
    public String failToLogin() throws JsonProcessingException {
        if(failToLogin==null){
            failToLogin=new Result(ResultCode.Fail_To_Login);
        }
        return objectMapper.writeValueAsString(failToLogin);
    }
